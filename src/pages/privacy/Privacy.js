        ...
        <>
            <div className="privacy-parent parent">
                <div className="privacy-cont cont">
                    <h1 className="title">Privacy Policy for Wave Solutions</h1>
                    <p>
                        <span>
                            {" "}
                            At Wave Solutions, accessible from
                            <a href="https://www.wavesolutions.in/">https://www.wavesolutions.in/</a>, one of our main priorities is the
                            privacy of our visitors. This Privacy Policy document contains
                            types of information that is collected and recorded by
                            Wave Solutions and how we use it.
                        </span>
                        <span>
                    ...
                    <p>
                        <span>
                            {" "}
                            Wave Solutions follows a standard procedure of using log files.
                    ...
                    <p>
                        <span>
                            Like any other website, Wave Solutions uses 'cookies'. These
                    ...
                    <p>
                        Note that Wave Solutions has no access to or control over these
                        cookies that are used by third-party advertisers.
                    </p>

                    <h3>Third Party Privacy Policies</h3>
                    <p>
                        Wave Solutions's Privacy Policy does not apply to other
                    ...
                    <p>Wave Solutions does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>
                </div>
            </div>
        </>
    )
